...
describe("AirDrop", function () {
  ...
  before(async function () {
    ...
    this.token = (await ethers.getContractFactory("Token", addrs[0])).attach(tokenAddress);

    expect(await this.token.balanceOf(this.ethSwap.address)).to.equal(TOKENS_IN_POOL);
